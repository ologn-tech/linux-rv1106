...
#define OX03J10_BITS_PER_SAMPLE		12
#define OX03J10_LINK_FREQ_240		240000000

#define PIXEL_RATE_WITH_240M_12BIT	(OX03J10_LINK_FREQ_240 * 2 * \
					OX03J10_LANES / OX03J10_BITS_PER_SAMPLE)

#define CHIP_ID				0x580343
#define OX03J10_REG_CHIP_ID		0x300a
...
static const struct regval ox03j10_1920x1280_2_lanes_regs[] = {
...
static const struct ox03j10_mode supported_modes[] = {
	{
		...
		.reg_list = ox03j10_1920x1280_2_lanes_regs,
		.hdr_mode = NO_HDR,
