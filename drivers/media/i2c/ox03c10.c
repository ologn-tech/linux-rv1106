...
#define OX03C10_LINK_FREQ_600MHZ	600000000
...
#define OX03C10_PIXEL_RATE_480		(OX03C10_LINK_FREQ_480MHZ / OX03C10_BITS_PER_SAMPLE \
									* 2 *  OX03C10_LANES)
#define OX03C10_PIXEL_RATE_600		(OX03C10_LINK_FREQ_600MHZ / OX03C10_BITS_PER_SAMPLE \
									* 2 *  OX03C10_LANES)
#define OX03C10_PIXEL_RATE_MAX		OX03C10_PIXEL_RATE_600
...
enum ox03c10_hdr_operating_mode {
	...
	OX03C10_HDR4_DCG_SPD_VS_12BIT = 2,
...
static const struct regval ox03c10_1920x1080_60fps_HDR4_LFR_PWL12_mipi1200[] = {
	{0x0103, 0x01},
	{0x0107, 0x01},
	{DELAY_MS, 6},
	{0x4d5a, 0x1c},
...
static struct rkmodule_hdr_compr ox03c10_hdr_compr_12 = {
	.segment = HDR_COMPR_SEGMENT_16,
	.bit = 20,
	.k_shift = 7,
	.data_src_shitf = {
		0, 10, 12, 13, 14, 15, 16, 16,
		17, 17, 18, 18, 19, 19, 20, 20
	},
	.data_compr = {
		0, 256, 437, 877, 1462, 1901, 2340, 2779,
		2998, 3217, 3280, 3407, 3470, 3597, 3872, 4095,
	},
	.slope_k = {
		0, 511, 1448, 1191, 1792, 4777, 4777, 4777,
		19152, 19152, 133152, 66052, 266305, 132104, 122016, 150468,
	},
};
...
static const struct ox03c10_mode supported_modes[] = {
	{
		...
		.hts_def = 0x0b62,
		.vts_def = 0x02ae * 2,
		.reg_list = ox03c10_1920x1080_60fps_HDR4_LFR_PWL12_mipi1200,
		.hdr_mode = HDR_COMPR,
		.hdr_compr = &ox03c10_hdr_compr_12,
		.bpp = 12,
		.mipi_freq_idx = 2,
		.hdr_operating_mode = OX03C10_HDR4_DCG_SPD_VS_12BIT,
...
static int ox03c10_set_ctrl(struct v4l2_ctrl *ctrl)
{
	...
	case V4L2_CID_EXPOSURE:
		...
		ret |= ox03c10_write_reg(ox03c10->client, OX03C10_GROUP_UPDATE_ADDRESS,
					 OX03C10_REG_VALUE_08BIT,
					 OX03C10_GROUP_UPDATE_LAUNCH);
		dev_info(&client->dev, "set exposure val:0x%x ret:%d",
			 ctrl->val, ret);
		break;
	case V4L2_CID_ANALOGUE_GAIN:
		...
		*/
		...
		dev_info(&client->dev,
			 "set gain val:0x%x ret:%d again:0x%x, dgain:0x%x",
			 ctrl->val, ret, again, dgain);
		break;
	case V4L2_CID_VBLANK:
