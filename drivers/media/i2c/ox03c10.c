...
static const struct regval ox03c10_1920x1280_30fps_HDR4_LFR_PWL12_mipi1200[] = {
	{0x0103, 0x01},
	{0x0107, 0x01},
	{DELAY_MS, 6},
	{0x4d5a, 0x1c},
...
static struct rkmodule_hdr_compr ox03c10_hdr_compr_12 = {
	...
	.data_compr = {
		0, 437, 877, 1462, 1901, 2340, 2779, 2998,
		3217, 3280, 3407, 3470, 3597, 3688, 3872, 4095,
	},
	.slope_k = {
		0, 74, 74, 112, 298, 597, 1194, 4788,
		9576, 66576, 66052, 266305, 264208, 737460, 0, 0,
	},
};
...
static const struct ox03c10_mode supported_modes[] = {
	{
		...
		.hts_def = 0x0447,
		.vts_def = 0x02ae * 2,
		.reg_list = ox03c10_1920x1280_30fps_HDR4_LFR_PWL12_mipi1200,
		.hdr_mode = HDR_COMPR,
		.hdr_compr = &ox03c10_hdr_compr_12,
		.bpp = 12,
		.mipi_freq_idx = 1,
		.hdr_operating_mode = OX03C10_HDR4_DCG_LFR_12BIT,
